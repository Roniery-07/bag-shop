...
export class ListCartItemByUserIdUsecase
  implements
    Usecase<ListCartItemByUserIdInputDto, ListCartItemByUserIdOutputDto>
{
  ...
  public async execute({
    userId,
  }: ListCartItemByUserIdInputDto): Promise<ListCartItemByUserIdOutputDto> {
